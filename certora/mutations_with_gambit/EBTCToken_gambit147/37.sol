...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function decreaseAllowance(
        ...
        /// DeleteExpressionMutation(`require(cachedAllowances >= subtractedValue, "ERC20: decreased allowance below zero")` |==> `assert(true)`) of: `require(cachedAllowances >= subtractedValue, "ERC20: decreased allowance below zero");`
        assert(true);
        unchecked {
