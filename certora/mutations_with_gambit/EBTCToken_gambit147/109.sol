...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        /// RequireMutation(`cachedBalance >= amount` |==> `true`) of: `require(cachedBalance >= amount, "ERC20: burn amount exceeds balance");`
        require(true, "ERC20: burn amount exceeds balance");
