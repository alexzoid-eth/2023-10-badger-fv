...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        /// DeleteExpressionMutation(`require(cachedSenderBalances >= amount, "ERC20: transfer amount exceeds balance")` |==> `assert(true)`) of: `require(cachedSenderBalances >= amount, "ERC20: transfer amount exceeds balance");`
        assert(true);
