...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _requireCallerIsCdpM() internal view {
        /// DeleteExpressionMutation(`require(msg.sender == cdpManagerAddress, "EBTC: Caller is not CdpManager")` |==> `assert(true)`) of: `require(msg.sender == cdpManagerAddress, "EBTC: Caller is not CdpManager");`
        assert(true);
    }
