...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function decreaseAllowance(
        ...
        unchecked {
            /// DeleteExpressionMutation(`_approve(msg.sender, spender, cachedAllowances - subtractedValue)` |==> `assert(true)`) of: `_approve(msg.sender, spender, cachedAllowances - subtractedValue);`
            assert(true);
        }
        return true;
    }
