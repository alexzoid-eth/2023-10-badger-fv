...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function decreaseAllowance(
        ...
        unchecked {
            /// SwapArgumentsOperatorMutation(`cachedAllowances - subtractedValue` |==> `subtractedValue - cachedAllowances`) of: `_approve(msg.sender, spender, cachedAllowances - subtractedValue);`
            _approve(msg.sender, spender, subtractedValue - cachedAllowances);
        }
        return true;
    }
