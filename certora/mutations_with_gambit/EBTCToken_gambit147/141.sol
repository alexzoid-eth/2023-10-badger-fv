...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _requireValidRecipient(address _recipient) internal view {
        ...
        require(
            /// RequireMutation(`_recipient != cdpManagerAddress && _recipient != borrowerOperationsAddress` |==> `true`) of: `_recipient != cdpManagerAddress && _recipient != borrowerOperationsAddress,`
            true,
