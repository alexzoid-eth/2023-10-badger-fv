...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        unchecked {
            // Safe because of the check above
            /// SwapArgumentsOperatorMutation(`cachedBalance - amount` |==> `amount - cachedBalance`) of: `_balances[account] = cachedBalance - amount;`
            _balances[account] = amount - cachedBalance;
        }
