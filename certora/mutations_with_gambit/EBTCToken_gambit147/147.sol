...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _requireCallerIsCdpM() internal view {
        /// RequireMutation(`msg.sender == cdpManagerAddress` |==> `false`) of: `require(msg.sender == cdpManagerAddress, "EBTC: Caller is not CdpManager");`
        require(false, "EBTC: Caller is not CdpManager");
    }
