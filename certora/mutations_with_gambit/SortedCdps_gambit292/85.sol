...
contract SortedCdps is ISortedCdps {
    ...
    function insert(
        ...
        /// RequireMutation(`cdpManager.getCdpStatus(_id) == 0` |==> `true`) of: `require(cdpManager.getCdpStatus(_id) == 0, "SortedCdps: new id is NOT nonExistent!");`
        require(true, "SortedCdps: new id is NOT nonExistent!");
