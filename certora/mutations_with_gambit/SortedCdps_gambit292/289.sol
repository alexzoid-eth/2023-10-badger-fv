...
contract SortedCdps is ISortedCdps {
    ...
    function _requireCallerIsCdpManager() internal view {
        /// RequireMutation(`msg.sender == address(cdpManager)` |==> `true`) of: `require(msg.sender == address(cdpManager), "SortedCdps: Caller is not the CdpManager");`
        require(true, "SortedCdps: Caller is not the CdpManager");
    }
