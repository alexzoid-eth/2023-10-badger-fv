...
contract SortedCdps is ISortedCdps {
    ...
    function _requireCallerIsBOorCdpM() internal view {
        require(
            /// RequireMutation(`msg.sender == borrowerOperationsAddress || msg.sender == address(cdpManager)` |==> `false`) of: `msg.sender == borrowerOperationsAddress || msg.sender == address(cdpManager),`
            false,
