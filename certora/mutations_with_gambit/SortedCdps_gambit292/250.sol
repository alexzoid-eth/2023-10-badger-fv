    ...
    function _validInsertPosition(
        ...
        if (_prevId == dummyId && _nextId == dummyId) {
            ...
            return
                ...
                /// SwapArgumentsOperatorMutation(`cdpManager.getCachedNominalICR(_prevId) >= _NICR` |==> `_NICR >= cdpManager.getCachedNominalICR(_prevId)`) of: `cdpManager.getCachedNominalICR(_prevId) >= _NICR &&`
                _NICR >= cdpManager.getCachedNominalICR(_prevId) &&
