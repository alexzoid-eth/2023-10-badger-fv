...
contract SortedCdps is ISortedCdps {
    ...
    function _requireCallerIsCdpManager() internal view {
        /// RequireMutation(`msg.sender == address(cdpManager)` |==> `false`) of: `require(msg.sender == address(cdpManager), "SortedCdps: Caller is not the CdpManager");`
        require(false, "SortedCdps: Caller is not the CdpManager");
    }
