...
contract SortedCdps is ISortedCdps {
    ...
    function reInsert(
        ...
        /// DeleteExpressionMutation(`_insert(_id, _newNICR, _prevId, _nextId)` |==> `assert(true)`) of: `_insert(_id, _newNICR, _prevId, _nextId); // @audit return id like in insert`
        assert(true); // @audit return id like in insert
    }
