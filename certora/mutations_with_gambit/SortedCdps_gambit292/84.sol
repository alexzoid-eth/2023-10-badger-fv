...
contract SortedCdps is ISortedCdps {
    ...
    function insert(
        ...
        /// DeleteExpressionMutation(`require(cdpManager.getCdpStatus(_id) == 0, "SortedCdps: new id is NOT nonExistent!")` |==> `assert(true)`) of: `require(cdpManager.getCdpStatus(_id) == 0, "SortedCdps: new id is NOT nonExistent!");`
        assert(true);
