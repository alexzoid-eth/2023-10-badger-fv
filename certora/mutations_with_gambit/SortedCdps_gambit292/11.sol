...
contract SortedCdps is ISortedCdps {
    ...
    function toCdpId(
        ...
        /// AssignmentMutation(`bytes32(blockHeight) << BLOCK_SHIFT` |==> `0`) of: `serialized |= bytes32(blockHeight) << BLOCK_SHIFT; // to accommendate more than 4.2 billion blocks`
        serialized |= 0; // to accommendate more than 4.2 billion blocks
