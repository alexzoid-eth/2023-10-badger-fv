...
contract CollSurplusPool is ICollSurplusPool, ReentrancyGuard, AuthNoOwner {
    ...
    function claimSurplusCollShares(address _account) external override {
        ...
        /// SwapArgumentsOperatorMutation(`claimableColl > 0` |==> `0 > claimableColl`) of: `require(claimableColl > 0, "CollSurplusPool: No collateral available to claim");`
        require(0 > claimableColl, "CollSurplusPool: No collateral available to claim");
