...
contract CollSurplusPool is ICollSurplusPool, ReentrancyGuard, AuthNoOwner {
    ...
    function _requireCallerIsActivePool() internal view {
        /// RequireMutation(`msg.sender == activePoolAddress` |==> `true`) of: `require(msg.sender == activePoolAddress, "CollSurplusPool: Caller is not Active Pool");`
        require(true, "CollSurplusPool: Caller is not Active Pool");
    }
