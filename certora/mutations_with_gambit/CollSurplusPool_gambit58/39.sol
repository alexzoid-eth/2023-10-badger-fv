...
contract CollSurplusPool is ICollSurplusPool, ReentrancyGuard, AuthNoOwner {
    ...
    function _requireCallerIsActivePool() internal view {
        /// DeleteExpressionMutation(`require(msg.sender == activePoolAddress, "CollSurplusPool: Caller is not Active Pool")` |==> `assert(true)`) of: `require(msg.sender == activePoolAddress, "CollSurplusPool: Caller is not Active Pool");`
        assert(true);
    }
