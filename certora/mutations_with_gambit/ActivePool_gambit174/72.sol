...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function decreaseSystemDebt(uint256 _amount) external override {
        ...
        /// SwapArgumentsOperatorMutation(`systemDebt - _amount` |==> `_amount - systemDebt`) of: `uint256 cachedSystemDebt = systemDebt - _amount;`
        uint256 cachedSystemDebt = _amount - systemDebt;
