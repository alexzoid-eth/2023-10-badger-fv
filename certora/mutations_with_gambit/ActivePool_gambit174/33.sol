...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function transferSystemCollSharesAndLiquidatorReward(
        ...
        /// DeleteExpressionMutation(`_transferCollSharesWithContractHooks(_account, totalShares)` |==> `assert(true)`) of: `_transferCollSharesWithContractHooks(_account, totalShares);`
        assert(true);
    }
