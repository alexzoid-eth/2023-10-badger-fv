...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function flashLoan(
        ...
        /// DeleteExpressionMutation(`collateral.transferFrom(address(receiver), address(this), amountWithFee)` |==> `assert(true)`) of: `collateral.transferFrom(address(receiver), address(this), amountWithFee);`
        assert(true);
