...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function setFeeBps(uint256 _newFee) external requiresAuth {
        ...
        /// SwapArgumentsOperatorMutation(`_newFee <= MAX_FEE_BPS` |==> `MAX_FEE_BPS <= _newFee`) of: `require(_newFee <= MAX_FEE_BPS, "ERC3156FlashLender: _newFee should <= MAX_FEE_BPS");`
        require(MAX_FEE_BPS <= _newFee, "ERC3156FlashLender: _newFee should <= MAX_FEE_BPS");
