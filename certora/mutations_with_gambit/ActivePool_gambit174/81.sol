...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function _requireCallerIsCdpManager() internal view {
        /// RequireMutation(`msg.sender == cdpManagerAddress` |==> `true`) of: `require(msg.sender == cdpManagerAddress, "ActivePool: Caller is not CdpManager");`
        require(true, "ActivePool: Caller is not CdpManager");
    }
