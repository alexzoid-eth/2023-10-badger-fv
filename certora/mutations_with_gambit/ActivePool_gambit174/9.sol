...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function transferSystemCollShares(address _account, uint256 _shares) public override {
        ...
        /// SwapArgumentsOperatorMutation(`cachedSystemCollShares >= _shares` |==> `_shares >= cachedSystemCollShares`) of: `require(cachedSystemCollShares >= _shares, "!ActivePoolBal");`
        require(_shares >= cachedSystemCollShares, "!ActivePoolBal");
        unchecked {
