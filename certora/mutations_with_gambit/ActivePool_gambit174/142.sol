...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function claimFeeRecipientCollShares(uint256 _shares) external override requiresAuth {
        ...
        require(
            /// SwapArgumentsOperatorMutation(`cachedFeeRecipientCollShares >= _shares` |==> `_shares >= cachedFeeRecipientCollShares`) of: `cachedFeeRecipientCollShares >= _shares,`
            _shares >= cachedFeeRecipientCollShares,
