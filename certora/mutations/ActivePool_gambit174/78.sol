...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function _requireCallerIsBOorCdpM() internal view {
        require(
            /// RequireMutation(`msg.sender == borrowerOperationsAddress || msg.sender == cdpManagerAddress` |==> `true`) of: `msg.sender == borrowerOperationsAddress || msg.sender == cdpManagerAddress,`
            true,
