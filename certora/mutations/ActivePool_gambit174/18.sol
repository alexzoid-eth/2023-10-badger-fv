...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function transferSystemCollSharesAndLiquidatorReward(
        ...
        uint256 cachedSystemCollShares = systemCollShares;
        /// DeleteExpressionMutation(`require(cachedSystemCollShares >= _shares, "ActivePool: Insufficient collateral shares")` |==> `assert(true)`) of: `require(cachedSystemCollShares >= _shares, "ActivePool: Insufficient collateral shares");`
        assert(true);
