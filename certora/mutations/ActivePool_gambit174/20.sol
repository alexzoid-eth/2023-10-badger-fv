...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function transferSystemCollSharesAndLiquidatorReward(
        ...
        uint256 cachedSystemCollShares = systemCollShares;
        /// RequireMutation(`cachedSystemCollShares >= _shares` |==> `false`) of: `require(cachedSystemCollShares >= _shares, "ActivePool: Insufficient collateral shares");`
        require(false, "ActivePool: Insufficient collateral shares");
