...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function _requireCallerIsCdpManager() internal view {
        /// DeleteExpressionMutation(`require(msg.sender == cdpManagerAddress, "ActivePool: Caller is not CdpManager")` |==> `assert(true)`) of: `require(msg.sender == cdpManagerAddress, "ActivePool: Caller is not CdpManager");`
        assert(true);
    }
