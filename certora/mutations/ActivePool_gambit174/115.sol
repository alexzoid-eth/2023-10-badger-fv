...
contract ActivePool is IActivePool, ERC3156FlashLender, ReentrancyGuard, BaseMath, AuthNoOwner {
    ...
    function flashLoan(
        ...
        require(
            /// SwapArgumentsOperatorMutation(`collateral.sharesOf(address(this)) >= systemCollShares` |==> `systemCollShares >= collateral.sharesOf(address(this))`) of: `collateral.sharesOf(address(this)) >= systemCollShares,`
            systemCollShares >= collateral.sharesOf(address(this)),
