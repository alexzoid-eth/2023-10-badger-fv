...
contract SortedCdps is ISortedCdps {
    ...
    function toCdpId(
        ...
        /// DeleteExpressionMutation(`serialized |= bytes32(blockHeight) << BLOCK_SHIFT` |==> `assert(true)`) of: `serialized |= bytes32(blockHeight) << BLOCK_SHIFT; // to accommendate more than 4.2 billion blocks`
        assert(true); // to accommendate more than 4.2 billion blocks
