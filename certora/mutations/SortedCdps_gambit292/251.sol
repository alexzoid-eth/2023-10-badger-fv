    ...
    function _validInsertPosition(
        ...
        if (_prevId == dummyId && _nextId == dummyId) {
            ...
            return
                ...
                /// SwapArgumentsOperatorMutation(`_NICR >= cdpManager.getCachedNominalICR(_nextId)` |==> `cdpManager.getCachedNominalICR(_nextId) >= _NICR`) of: `_NICR >= cdpManager.getCachedNominalICR(_nextId);`
                cdpManager.getCachedNominalICR(_nextId) >= _NICR;
        }
    }
