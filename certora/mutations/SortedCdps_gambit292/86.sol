...
contract SortedCdps is ISortedCdps {
    ...
    function insert(
        ...
        /// RequireMutation(`cdpManager.getCdpStatus(_id) == 0` |==> `false`) of: `require(cdpManager.getCdpStatus(_id) == 0, "SortedCdps: new id is NOT nonExistent!");`
        require(false, "SortedCdps: new id is NOT nonExistent!");
