...
contract SortedCdps is ISortedCdps {
    ...
    function _requireCallerIsCdpManager() internal view {
        /// DeleteExpressionMutation(`require(msg.sender == address(cdpManager), "SortedCdps: Caller is not the CdpManager")` |==> `assert(true)`) of: `require(msg.sender == address(cdpManager), "SortedCdps: Caller is not the CdpManager");`
        assert(true);
    }
