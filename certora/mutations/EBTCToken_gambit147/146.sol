...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _requireCallerIsCdpM() internal view {
        /// RequireMutation(`msg.sender == cdpManagerAddress` |==> `true`) of: `require(msg.sender == cdpManagerAddress, "EBTC: Caller is not CdpManager");`
        require(true, "EBTC: Caller is not CdpManager");
    }
