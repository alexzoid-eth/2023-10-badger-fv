...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        /// DeleteExpressionMutation(`require(cachedBalance >= amount, "ERC20: burn amount exceeds balance")` |==> `assert(true)`) of: `require(cachedBalance >= amount, "ERC20: burn amount exceeds balance");`
        assert(true);
