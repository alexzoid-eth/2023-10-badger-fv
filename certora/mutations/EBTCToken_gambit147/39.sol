...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function decreaseAllowance(
        ...
        /// RequireMutation(`cachedAllowances >= subtractedValue` |==> `false`) of: `require(cachedAllowances >= subtractedValue, "ERC20: decreased allowance below zero");`
        require(false, "ERC20: decreased allowance below zero");
        unchecked {
