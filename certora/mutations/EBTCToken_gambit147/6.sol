...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    constructor(
        ...
        /// AssignmentMutation(`_buildDomainSeparator(_TYPE_HASH, hashedName, hashedVersion)` |==> `0`) of: `_CACHED_DOMAIN_SEPARATOR = _buildDomainSeparator(_TYPE_HASH, hashedName, hashedVersion);`
        _CACHED_DOMAIN_SEPARATOR = 0;
    }
