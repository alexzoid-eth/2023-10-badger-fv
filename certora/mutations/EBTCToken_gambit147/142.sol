...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _requireValidRecipient(address _recipient) internal view {
        ...
        require(
            /// RequireMutation(`_recipient != cdpManagerAddress && _recipient != borrowerOperationsAddress` |==> `false`) of: `_recipient != cdpManagerAddress && _recipient != borrowerOperationsAddress,`
            false,
