...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function increaseAllowance(
        ...
        /// DeleteExpressionMutation(`_approve(msg.sender, spender, _allowances[msg.sender][spender] + addedValue)` |==> `assert(true)`) of: `_approve(msg.sender, spender, _allowances[msg.sender][spender] + addedValue);`
        assert(true);
        return true;
    }
