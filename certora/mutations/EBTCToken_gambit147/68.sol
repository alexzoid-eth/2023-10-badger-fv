...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        /// SwapArgumentsOperatorMutation(`cachedSenderBalances >= amount` |==> `amount >= cachedSenderBalances`) of: `require(cachedSenderBalances >= amount, "ERC20: transfer amount exceeds balance");`
        require(amount >= cachedSenderBalances, "ERC20: transfer amount exceeds balance");
