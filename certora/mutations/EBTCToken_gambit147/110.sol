...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        /// RequireMutation(`cachedBalance >= amount` |==> `false`) of: `require(cachedBalance >= amount, "ERC20: burn amount exceeds balance");`
        require(false, "ERC20: burn amount exceeds balance");
