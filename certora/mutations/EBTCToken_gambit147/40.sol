...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function decreaseAllowance(
        ...
        /// SwapArgumentsOperatorMutation(`cachedAllowances >= subtractedValue` |==> `subtractedValue >= cachedAllowances`) of: `require(cachedAllowances >= subtractedValue, "ERC20: decreased allowance below zero");`
        require(subtractedValue >= cachedAllowances, "ERC20: decreased allowance below zero");
        unchecked {
