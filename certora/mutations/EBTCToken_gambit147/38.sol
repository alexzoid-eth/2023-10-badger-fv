...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function decreaseAllowance(
        ...
        /// RequireMutation(`cachedAllowances >= subtractedValue` |==> `true`) of: `require(cachedAllowances >= subtractedValue, "ERC20: decreased allowance below zero");`
        require(true, "ERC20: decreased allowance below zero");
        unchecked {
