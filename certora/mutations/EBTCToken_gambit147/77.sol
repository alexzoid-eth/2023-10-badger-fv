...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        unchecked {
            ...
            /// SwapArgumentsOperatorMutation(`cachedSenderBalances - amount` |==> `amount - cachedSenderBalances`) of: `_balances[sender] = cachedSenderBalances - amount;`
            _balances[sender] = amount - cachedSenderBalances;
        }
