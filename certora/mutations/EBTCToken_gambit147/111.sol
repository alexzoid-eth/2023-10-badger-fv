...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        /// SwapArgumentsOperatorMutation(`cachedBalance >= amount` |==> `amount >= cachedBalance`) of: `require(cachedBalance >= amount, "ERC20: burn amount exceeds balance");`
        require(amount >= cachedBalance, "ERC20: burn amount exceeds balance");
