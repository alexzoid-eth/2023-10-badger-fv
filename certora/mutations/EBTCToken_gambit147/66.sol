...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        /// RequireMutation(`cachedSenderBalances >= amount` |==> `true`) of: `require(cachedSenderBalances >= amount, "ERC20: transfer amount exceeds balance");`
        require(true, "ERC20: transfer amount exceeds balance");
