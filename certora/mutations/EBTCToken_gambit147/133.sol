...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function _approve(address owner, address spender, uint256 amount) internal {
        ...
        /// DeleteExpressionMutation(`require(spender != address(0), "EBTCToken: zero approve spender!")` |==> `assert(true)`) of: `require(spender != address(0), "EBTCToken: zero approve spender!");`
        assert(true);
