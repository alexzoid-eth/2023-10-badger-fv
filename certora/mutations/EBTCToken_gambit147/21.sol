...
contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
    ...
    function transferFrom(
        ...
        if (cachedAllowance != type(uint256).max) {
            /// RequireMutation(`cachedAllowance >= amount` |==> `true`) of: `require(cachedAllowance >= amount, "ERC20: transfer amount exceeds allowance");`
            require(true, "ERC20: transfer amount exceeds allowance");
            unchecked {
