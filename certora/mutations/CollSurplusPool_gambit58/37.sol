...
contract CollSurplusPool is ICollSurplusPool, ReentrancyGuard, AuthNoOwner {
    ...
    function _requireCallerIsCdpManager() internal view {
        /// RequireMutation(`msg.sender == cdpManagerAddress` |==> `true`) of: `require(msg.sender == cdpManagerAddress, "CollSurplusPool: Caller is not CdpManager");`
        require(true, "CollSurplusPool: Caller is not CdpManager");
    }
