...
contract CollSurplusPool is ICollSurplusPool, ReentrancyGuard, AuthNoOwner {
    ...
    function claimSurplusCollShares(address _account) external override {
        ...
        /// RequireMutation(`claimableColl > 0` |==> `false`) of: `require(claimableColl > 0, "CollSurplusPool: No collateral available to claim");`
        require(false, "CollSurplusPool: No collateral available to claim");
