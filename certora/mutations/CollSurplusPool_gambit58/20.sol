...
contract CollSurplusPool is ICollSurplusPool, ReentrancyGuard, AuthNoOwner {
    ...
    function claimSurplusCollShares(address _account) external override {
        ...
        /// DeleteExpressionMutation(`require(cachedTotalSurplusCollShares >= claimableColl, "!CollSurplusPoolBal")` |==> `assert(true)`) of: `require(cachedTotalSurplusCollShares >= claimableColl, "!CollSurplusPoolBal");`
        assert(true);
