...
contract CollSurplusPool is ICollSurplusPool, ReentrancyGuard, AuthNoOwner {
    ...
    function _requireCallerIsCdpManager() internal view {
        /// DeleteExpressionMutation(`require(msg.sender == cdpManagerAddress, "CollSurplusPool: Caller is not CdpManager")` |==> `assert(true)`) of: `require(msg.sender == cdpManagerAddress, "CollSurplusPool: Caller is not CdpManager");`
        assert(true);
    }
