...
contract CollSurplusPool is ICollSurplusPool, ReentrancyGuard, AuthNoOwner {
    ...
    function claimSurplusCollShares(address _account) external override {
        ...
        unchecked {
            /// AssignmentMutation(`cachedTotalSurplusCollShares - claimableColl` |==> `1`) of: `totalSurplusCollShares = cachedTotalSurplusCollShares - claimableColl;`
            totalSurplusCollShares = 1;
        }
